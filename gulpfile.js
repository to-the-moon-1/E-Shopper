...
function scripts() {
    return src('app/js/**/*.js') // Берём файлы из источников
...
function styles() {
    return src('app/css/**/*.css') // Берём все файлы со стилями из папки источника
        .pipe(concat('eshopper.min.css')) // Конкатенируем в файл app.min.js
